...
function WouldYouRatherQuestion({ question, onAnswer, onSkip, disabled }) {
  ...
  return (
    <div className="would-you-rather-question">
      <div className="question-header">
        ...
        <span className="question-type-badge">would you rather</span>
      </div>
      ...
      <div className="question-footer">
        <span className="question-hint">
          {selectedOption ? `selected: ${selectedOption}` : 'pick your poison'}
        </span>
      </div>
    </div>
  );
