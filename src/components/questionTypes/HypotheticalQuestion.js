...
function HypotheticalQuestion({ question, onAnswer, onSkip, disabled }) {
  ...
  return (
    <div className="long-form-question">
      <div className="question-header">
        ...
        <span className="question-type-badge">hypothetical</span>
      </div>
...
export default HypotheticalQuestion;
